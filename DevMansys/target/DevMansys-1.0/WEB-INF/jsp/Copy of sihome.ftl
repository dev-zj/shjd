						...
						<div class="table1">
							       <table width="100%" border="0" cellspacing="0" cellpadding="0">
										  <tr>
										    ...
										    <td width="6%" height="40" align="center" valign="middle" bgcolor="#f7f7f7">学校/单位</td>
										    <td width="6%" height="40" align="center" valign="middle" bgcolor="#f7f7f7">院系/部门</td>
											...
											<#if equipUserInfoList?size &gt;0>
												<#list equipUserInfoList as  userInfo>
										  		<tr>
										    		...
										    		<td height="40" align="center" valign="middle">
														<#if userInfo.auditStatus == 'todo'><a href="#" onClick="javascript:auditUser(${userInfo.id},'doing');">审核</a></#if>
														<#if userInfo.auditStatus == 'doing'><a href="#" onClick="javascript:auditUser(${userInfo.id},'done');">注册</a></#if>
														<#if userInfo.auditStatus == 'done'></#if>
										    		</td>    		
										  		</tr>
												</#list>
											</#if>
