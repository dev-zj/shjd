   ...
   <div class="container_con2">
      ...
      <div class="rightpart">
	        <div class="rightpart_top1s">
				...
				<input type="hidden" name="toCheckStatus" id="toCheckStatus" value="${userInfo.toCheckStatus}"/>
				<input type="hidden" name="id" id="id" value="${userInfo.id}"/>
				<div class="fl2s2">
			    		<#if userInfo.auditStatus == 'todo'>
			    		<span class="label1s">&nbsp;</span><a href="javascript:auditUser(${userInfo.id},'doing');"><img src="../images/check.png"  /></a>
						</#if>
						<#if userInfo.auditStatus == 'doing'>
						<span class="label1s">&nbsp;</span><a href="javascript:auditUser(${userInfo.id},'done');"><img src="../images/register.png"  /></a>
						</#if>
						<#if userInfo.auditStatus == 'done'>
						<span class="label1s">&nbsp;</span><a href="javascript:auditUser(${userInfo.id},'');"><img src="../images/bt2.png"  /></a>
						</#if>
			    		<div class="clear"></div>
			    </div>
				</form>
