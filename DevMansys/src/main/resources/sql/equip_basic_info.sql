...
CREATE TABLE `equip_basic_info` (
  ...
  `isImportment` varchar(2) default NULL COMMENT '是否重点设备0：否；1：是',
  PRIMARY KEY  (`id`)
...
INSERT INTO `equip_basic_info` VALUES ('5', '5', '发射透射电子显微镜2-modify', 'Tecnai G2 F20', 'FEI5', '该仪器为场发射、高分辨透射电子显微镜，其加速电压为200KV。\\n主要参数为：束斑的漂移率为：0.675nm/min； ', '100w', '50', '该透射电镜可用于观察极微细材料的形貌、组织结构，并拍摄直观的图片，以及提供晶体结构、样品微区的化学成分和元素分布等方面信息。', '图像的分辨率指标为：点分辨率0.24nm，线分辨率0.102nm，信息分辨率0.15nm；\\n放大倍数：最高放大倍数达1.03MX。', '特色：该仪器具有高分辨率、高放大倍数的特点，且拍摄图片像素高。', '5', 'no', 'sch-dep', 'system', '2014-08-24', null, '2014-10-26 14:47:16', null);
...
INSERT INTO `equip_basic_info` VALUES ('8', '1', '测试名称', '测试型号', '测试厂商', '规格。。。。。。。', '40', '50年', '介绍。。。。。。。。。', '说明。。。。。。。', '流程。。。。。。', '5', 'yes', 'sch-dep', 'super_admin', '2014-10-26', null, '2014-10-26 17:32:18', null);
